...
use DateTimeZone;
use Mvc\Exception;
use Mvc\Http\ResponseInterface;
use Mvc\Http\Response\CookiesInterface;
use Mvc\Http\Response\Headers;
use Mvc\Http\Response\HeadersInterface;
use Mvc\Url;
 ...
 * Mvc\HTTP\Response is the Mvc component responsible to achieve this task.
 * HTTP responses are usually composed by headers and body.
 *
 *<code>
 *  $response = new Mvc\Http\Response();
...
class Response implements ResponseInterface
{
     ...
     * Headers
     *
     * @var null|\Mvc\Http\Response\HeadersInterface
     * @access protected
     */
     ...
     * Cookies
     *
     * @var null|\Mvc\Ḩttp\Response\CookiesInterface
     * @access protected
     */
     ...
     *
     * @param \Mvc\Http\Response\HeadersInterface $headers
     * @throws Exception
     */
     ...
     *
     * @return \Mvc\Http\Response\HeadersInterface
     */
    public static function getHeaders()
    {
        if (is_null(self::$_headers) === true) {
            /*
             * A Mvc\Http\Response\Headers bag is temporary used to manage the headers
     ...
     *
     * @param \Mvc\Http\Response\CookiesInterface $cookies
     * @throws Exception
     */
     ...
     *
     * @return \Mvc\Http\Response\CookiesInterface|null
     */
