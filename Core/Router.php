...
class Router implements RouterInterface
{
     ...
     * @return \Mvc\Router\Route
     */
    public function add($pattern, $paths = null, $httpMethods = null)
    {
        //Every route is internally stored as a Mvc\Router\Route
     ...
     *
     * @param int $id
     * @return \Mvc\Router\Route|boolean
     * @throws Exception
     */
