...
abstract class Text
{
    ...
    */
     ...
     *
     *<code>
     *  echo \Mvc\Text::camelize('coco_bongo'); //CocoBongo
     *</code>
     *
     * @param string $str
     * @return string
     ...
     *
     *<code>
     *  echo \Mvc\Text::camelize('CocoBongo'); //coco_bongo
     *</code>
     *
     * @param string $str
     * @return string
     ...
     *
     *<code>
     *  echo \Mvc\Text::increment("a"); // "a_1"
     *  echo \Mvc\Text::increment("a_1"); // "a_2"
     *</code>
     *
     * @param string $str
     ...
     *
     *<code>
     *  echo \Mvc\Text::random(Mvc\Text::RANDOM_ALNUM); //"aloiwkqz"
     *</code>
     *
     * @param int $type
     ...
     *
     *<code>
     *  echo \Mvc\Text::startsWith("Hello", "He"); // true
     *  echo \Mvc\Text::startsWith("Hello", "he"); // false
     *  echo \Mvc\Text::startsWith("Hello", "he", true); // true
     *</code>
     *
     * @param string $str
     * @param string $start
     ...
     *
     *<code>
     *  echo \Mvc\Text::endsWith("Hello", "llo"); // true
     *  echo \Mvc\Text::endsWith("Hello", "LLO"); // false
     *  echo \Mvc\Text::endsWith("Hello", "LLO", true); // true
     *</code>
     *
     * @param string $str
     * @param string $end
