...
use Mvc\Http\Request\FileInterface;
use Mvc\Exception;

/**
 * Mvc\Http\Request\File
 *
...
class File implements FileInterface
{
    ...
    */
    ...
    /**
     * \Mvc\Http\Request\File constructor
     *
     * @param array $file
    ...
    public function __construct($file, $key = null)
    {
        if (is_array($file) === false) {
            throw new Exception("Mvc\\Http\\Request\\File requires a valid uploaded file");
        }
    ...
    */
     ...
     * Set State
     *
     * @return \Mvc\Http\Request\FileInterface
    */
