 ...
 * Mvc\Config
 *
 * Mvc\Config is designed to simplify the access to, and the use of, configuration data within applications.
 * It provides a nested object property based user interface for accessing this configuration data within
 * application code.
 *
 *<code>
 *  $config = new Mvc\Config(array(
 *      "database" => array(
 *          "adapter" => "Mysql",
 *          "host" => "localhost",
 *          "username" => "scott",
...
class Config implements ArrayAccess, Countable
{
    ...
    */
     ...
     *
     * @brief void \Mvc\Config::merge(array|object $with)
     *
     *<code>
     *  $appConfig = new \Mvc\Config(array('database' => array('host' => 'localhost')));
     *  $globalConfig->merge($config2);
     *</code>
     *
     * @param \Mvc\Config|array $config
     ...
     *
     * @brief array \Mvc\Config::toArray(bool $recursive = true);
     *
     *<code>
    ...
    */
    ...
    /**
     * Restores the state of a \Mvc\Config object
     *
     * @param array $data
     * @return \Mvc\Config
     */
